...
BOT_TOKEN = '8477103176:AAEKMu5ZCvEU1bz89DDXdsfk6Taa8DKNqZ4'
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            if latest_file.endswith('.mp4'):
                with open(file_path, 'rb') as video:
                    bot.send_video(message.chat.id, video, caption=post.caption or "ویدیو دانلود شد!")
            else:
                with open(file_path, 'rb') as photo:
                    bot.send_photo(message.chat.id, photo, caption=post.caption or "عکس دانلود شد!")
